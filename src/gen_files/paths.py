...
add_suffix_output_dir = os.path.join(output_dir, 'output_of_add_suffix_to_csv')
...
dir_for_general_files = r"Y:\QA\Automation\RefactoringAssistant"
dir_sensitive_data  = os.path.join(dir_for_general_files, "do_not_delete")
path_for_guides = os.path.join(dir_for_general_files, "Guides")
...
path_for_default_config_if_first_is_open = os.path.join(dir_for_config_files, 'default_config_if_first_is_open.json')
path_local_temp_default_config = os.path.join(main_dir, "temp_copy_of_default_config_overwritten_at_runtime.json")
path_local_custom_config = os.path.join(main_dir, "local_custom_config.json")
