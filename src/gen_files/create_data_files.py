...
def rec_fill_name_to_path_dict(src_dir):
    with open(p.init_dict_file_name_to_path, 'a', encoding='utf-8') as temp_dict:
...
def init_application_properties_from_config(path_to_json_config):
    ...
    ap.csv_type_value_automated = json_data["csv_type_value_automated"]
...
def set_application_properties():
    ...
    if custom_config_is_different:
        ...
        elif cmd == enums.CustomOrDefaultConfig.OVERWRITE_MY_CUSTOM_CONFIG_WITH_DEFAULT.value:
