...
def reassign_project_path():
    ...
    new_path = input("Please enter the path to test folder.\n"
                     "It should something like this: " + r'C:\urm\workspace-1.0.0.2-URM\alma_itest_ux\src\test' + '\n')
    fu.write_txt_to_file(p.intelliJ_base_txt_file_path, new_path)
