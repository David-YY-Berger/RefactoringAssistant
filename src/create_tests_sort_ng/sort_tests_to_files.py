...
def priv_write_tests_to_output(ng_tests, non_ng_tests, ng_output_path, non_ng_output_path):
    num_ng_tests = int(len(ng_tests) / 2)
    ...
    print("Wrote " + str(num_ng_tests) + " tests to " + ng_output_path)
    ...
    print("Wrote " + str(num_non_ng_tests) + " tests to " + non_ng_output_path)

    print("Total test analyzed: " + str(num_ng_tests + num_non_ng_tests))
