...
def main_script():
    ...
    pf.print_note("\n\nTests found only in Source 1 (" + str(len(differences_list[0])) + " tests):")
    pf.print_list_by_row(differences_list[0])
    pf.print_note("\n\nTests found only in Source 2 (" + str(len(differences_list[1])) + " tests):")
    ...
    pf.print_note("\nTotal tests analyzed: " + str(sum(len(sublist) for sublist in differences_list)) + ".\n"
                  + "Only in Source 1: " + str(len(differences_list[0])) + " Only in Source 2: " + str(len(differences_list[1])) + "| In Both: " + str(differences_list[2]))
