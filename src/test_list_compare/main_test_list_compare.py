...
def main_script():
    ...
    pf.print_note("\n\n" + str(len(differences_list[0])) + " Tests found only in Source 1 (" + src_type1 +")")
    ...
    pf.print_note("\n\n" + str(len([test.test_name for test in differences_list[1]])) + " Tests found only in Source 2 (" + src_type2 + ")")
