...
def main_script():
    ...
    tests_only_in_src1 = tcf.get_nice_string_list_test_name_section(differences_list[0])
    tests_only_in_src2 = tcf.get_nice_string_list_test_name_section(differences_list[1])
