...
Setup > Setup > Load File.. (at the bottom of the dialog) > Save
    For QAC01 tests, you can use: 'Y:\QA\Automation\RefactoringAssistant\setup_automation_player SQA02_NA03_NG.xml'
    For SQA_NA01, you can use: 'Y:\QA\Automation\RefactoringAssistant\setup_automation_player SQA02_NA01_NG.xml'
Adjust the institutions according to your area..
(4) Run the playlist, and mark off the tests that passed as 'passed without code change'
"""
